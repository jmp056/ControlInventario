...
namespace ControlInventario.UI.Registros
{
    public partial class rCuadreDeCaja : Form
    {
        ...
        public rCuadreDeCaja(int cuadreDeCajaId)
        {
        ...
        private void rCuadreDeCaja_Load(object sender, EventArgs e)
        {
        ...
        private void DosMilNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (DosMilNumericUpDown.Text == "")
        ...
        private void MilNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (MilNumericUpDown.Value == 0)
                MilNumericUpDown.Text = "";
        }

        private void MilNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (MilNumericUpDown.Text == "")
        ...
        private void QuinientosNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (QuinientosNumericUpDown.Value == 0)
                QuinientosNumericUpDown.Text = "";
        }

        private void QuinientosNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (QuinientosNumericUpDown.Text == "")
        ...
        private void DoscientosNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (DoscientosNumericUpDown.Value == 0)
                DoscientosNumericUpDown.Text = "";
        }

        private void DoscientosNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (DoscientosNumericUpDown.Text == "")
        ...
        private void CienNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (CienNumericUpDown.Value == 0)
                CienNumericUpDown.Text = "";
        }

        private void CienNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (CienNumericUpDown.Text == "")
        ...
        private void CincuentaNumericUpDown_DragEnter(object sender, DragEventArgs e)
        {
}

        private void CincuentaNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (CincuentaNumericUpDown.Value == 0)
                CincuentaNumericUpDown.Text = "";
        }

        private void CincuentaNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (CincuentaNumericUpDown.Text == "")
        ...
        private void VeinticincoNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (VeinticincoNumericUpDown.Value == 0)
                VeinticincoNumericUpDown.Text = "";
        }

        private void VeinticincoNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (VeinticincoNumericUpDown.Text == "")
        ...
        private void VeinteNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (VeinteNumericUpDown.Value == 0)
                VeinteNumericUpDown.Text = "";
        }

        private void VeinteNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (VeinteNumericUpDown.Text == "")
        ...
        private void DiezNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (DiezNumericUpDown.Value == 0)
                DiezNumericUpDown.Text = "";
        }

        private void DiezNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (DiezNumericUpDown.Text == "")
        ...
        private void CincoNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (CincoNumericUpDown.Value == 0)
                CincoNumericUpDown.Text = "";
        }

        private void CincoNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (CincoNumericUpDown.Text == "")
        ...
        private void UnoNumericUpDown_Enter(object sender, EventArgs e)
        {
            if (UnoNumericUpDown.Value == 0)
                UnoNumericUpDown.Text = "";
        }

        private void UnoNumericUpDown_Leave(object sender, EventArgs e)
        {
            if (UnoNumericUpDown.Text == "")
